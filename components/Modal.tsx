...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, maxWidth = 'max-w-[440px]', noPadding = false }) => {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start pt-[10vh] justify-center p-4">
      {/* Backdrop */}
      <div 
